...
class BlockCommunityPreview(BaseBlock):
    ...
    def __init__(self, community_id=None, site_id=None, slug=None, title=None, description=None, image=None, variant=None, are_social_buttons_visible=None, is_followed=None, are_notifications_enabled=None, members=None, *args, **kwargs):  # noqa: E501
    ...
    def variant(self, variant):
        ...
        allowed_values = ["VERTICAL", "VERTICAL_STRETCH", "HORIZONTAL", "HORIZONTAL_STRETCH"]  # noqa: E501
    ...
    def are_social_buttons_visible(self, are_social_buttons_visible):
        ...
        if are_social_buttons_visible is None:
            raise ValueError("Invalid value for `are_social_buttons_visible`, must not be `None`")  # noqa: E501
