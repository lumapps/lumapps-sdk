...
class ErrorSource(object):
    ...
    """
    swagger_types = {"pointer": "str", "parameter": "str"}

    attribute_map = {"pointer": "pointer", "parameter": "parameter"}
    ...
    def pointer(self):
        ...
        A JSON Pointer [RFC6901] to the associated entity in the request document example:   - \"/data\" for a primary data object   - \"/data/attributes/title\" for a specific attribute   # noqa: E501
    ...
    def parameter(self):
        ...
        A string indicating which URI query parameter caused the error.  # noqa: E501
