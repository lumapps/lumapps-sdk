...
class BlockInappropriate(BaseBlock):
    ...
    def __init__(self, report_count=None, last_reported_at=None, is_reported_by_me=None, *args, **kwargs):  # noqa: E501
    ...
    def report_count(self, report_count):
        ...
        if report_count is None:
            raise ValueError("Invalid value for `report_count`, must not be `None`")  # noqa: E501
    ...
    def last_reported_at(self, last_reported_at):
        ...
        if last_reported_at is None:
            raise ValueError("Invalid value for `last_reported_at`, must not be `None`")  # noqa: E501
    ...
    def is_reported_by_me(self, is_reported_by_me):
        ...
        if is_reported_by_me is None:
            raise ValueError("Invalid value for `is_reported_by_me`, must not be `None`")  # noqa: E501
