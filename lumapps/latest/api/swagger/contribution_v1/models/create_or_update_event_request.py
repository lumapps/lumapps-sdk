...
class CreateOrUpdateEventRequest(object):
    ...
    def __init__(self, template_id=None, structured_content_id=None, starts_at=None, ends_at=None, organizers=None, location=None, external_url=None, external_url_label=None):  # noqa: E501
