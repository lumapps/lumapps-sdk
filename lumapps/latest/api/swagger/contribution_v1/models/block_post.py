...
class BlockPost(BaseBlock):
    ...
    def __init__(self, post_id=None, post_type=None, community=None, site=None, author=None, reports=None, shares=None, share_count=None, event_starts_at=None, event_ends_at=None, is_answered=None, title=None, content=None, visible_lines=10, can_share=None, can_edit=None, can_move=None, can_delete=None, user_mentions=None, links=None, tags=None, files=None, images=None, reactions=None, votes=None, idea_status=None, article_preview=None, play_video_preview=None, order=None, version=0, *args, **kwargs):  # noqa: E501
    ...
    def post_type(self, post_type):
        ...
        if post_type is None:
            raise ValueError("Invalid value for `post_type`, must not be `None`")  # noqa: E501
        allowed_values = ["DEFAULT", "EVENT", "IDEA", "QUESTION"]  # noqa: E501
        if post_type not in allowed_values:
            raise ValueError(
                "Invalid value for `post_type` ({0}), must be one of {1}"  # noqa: E501
                .format(post_type, allowed_values)
            )
    ...
    def visible_lines(self, visible_lines):
        ...
        if visible_lines is None:
            raise ValueError("Invalid value for `visible_lines`, must not be `None`")  # noqa: E501
    ...
    def can_share(self, can_share):
        ...
        if can_share is None:
            raise ValueError("Invalid value for `can_share`, must not be `None`")  # noqa: E501
    ...
    def can_move(self, can_move):
        ...
        """
        if can_move is None:
            raise ValueError("Invalid value for `can_move`, must not be `None`")  # noqa: E501
