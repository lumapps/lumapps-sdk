...
class StructuredContent(object):
    ...
    def __init__(self, id=None, dita=None, title=None, intro=None, featured_image=None, author_id=None, owner_users=None, owner_groups=None, updated_at=None):  # noqa: E501
    ...
    def owner_users(self, owner_users):
        ...
        if owner_users is None:
            raise ValueError("Invalid value for `owner_users`, must not be `None`")  # noqa: E501
    ...
    def owner_groups(self, owner_groups):
        ...
        if owner_groups is None:
            raise ValueError("Invalid value for `owner_groups`, must not be `None`")  # noqa: E501
