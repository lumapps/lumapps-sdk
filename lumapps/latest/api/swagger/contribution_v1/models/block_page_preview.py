...
class BlockPagePreview(BaseBlock):
    ...
    def __init__(self, page_id=None, slug=None, published_at=None, author=None, title=None, excerpt=None, image=None, variant=None, site=None, tags=None, metadata=None, reactions=None, order=None, external_url=None, *args, **kwargs):  # noqa: E501
