...
class BlockUserList(BaseBlock):
    ...
    """
    swagger_types = {"items": "list[BlockUser]"}
    ...
    def __init__(self, items=None, *args, **kwargs):  # noqa: E501
        """BlockUserList - a model defined in Swagger"""  # noqa: E501
        self._items = None
    ...
    @property
    def items(self):
        """Gets the items of this BlockUserList.  # noqa: E501


        :return: The items of this BlockUserList.  # noqa: E501
    ...
    def items(self, items):
        """Sets the items of this BlockUserList.


        :param items: The items of this BlockUserList.  # noqa: E501
        :type: list[BlockUser]
        """
        if items is None:
            raise ValueError(
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BlockUserList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BlockUserList):
            return False
