...
class BlockTitle(BaseBlock):
    ...
    def typography(self, typography):
        ...
        if typography is None:
            raise ValueError("Invalid value for `typography`, must not be `None`")  # noqa: E501
        allowed_values = ["headline", "title", "subtitle1", "subtitle2", "body1", "body2", "caption", "overline", "display1"]  # noqa: E501
        if typography not in allowed_values:
            raise ValueError(
                "Invalid value for `typography` ({0}), must be one of {1}"  # noqa: E501
                .format(typography, allowed_values)
            )
