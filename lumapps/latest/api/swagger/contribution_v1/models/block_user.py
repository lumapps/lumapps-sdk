...
class BlockUser(BaseBlock):
    ...
    def __init__(self, user_id=None, first_name=None, last_name=None, full_name=None, email=None, picture=None, variant=None, profile_primary_field_values=None, *args, **kwargs):  # noqa: E501
