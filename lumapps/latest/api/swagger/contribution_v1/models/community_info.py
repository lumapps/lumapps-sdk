...
class CommunityInfo(object):
    ...
    def __init__(self, community_id=None, name=None, slug=None, has_secure_storage=None, storage_doc_path=None):  # noqa: E501
    ...
    def has_secure_storage(self, has_secure_storage):
        ...
        if has_secure_storage is None:
            raise ValueError("Invalid value for `has_secure_storage`, must not be `None`")  # noqa: E501
