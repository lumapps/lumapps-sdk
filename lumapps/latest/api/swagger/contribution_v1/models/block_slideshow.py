...
class BlockSlideshow(BaseBlock):
    ...
    def __init__(self, variant=None, is_autoplay_enabled=None, autoplay_delay=None, is_navigation_visible=None, visible_items=None, items=None, *args, **kwargs):  # noqa: E501
    ...
    def is_autoplay_enabled(self, is_autoplay_enabled):
        ...
        if is_autoplay_enabled is None:
            raise ValueError("Invalid value for `is_autoplay_enabled`, must not be `None`")  # noqa: E501
    ...
    def is_navigation_visible(self, is_navigation_visible):
        ...
        if is_navigation_visible is None:
            raise ValueError("Invalid value for `is_navigation_visible`, must not be `None`")  # noqa: E501
