...
class BlockImage(BaseBlock):
    ...
    def __init__(self, url=None, focal_x=None, focal_y=None, crop_x=None, crop_y=None, height=None, width=None, scale_x=None, scale_y=None, rotate=None, fit=None, cover_ratio=None, corner_variant=None, *args, **kwargs):  # noqa: E501
    ...
    def cover_ratio(self, cover_ratio):
        ...
        :type: str
        """
        allowed_values = ["original", "horizontal", "vertical", "square", "free", "wide"]  # noqa: E501
        if cover_ratio not in allowed_values:
            raise ValueError(
                "Invalid value for `cover_ratio` ({0}), must be one of {1}"  # noqa: E501
                .format(cover_ratio, allowed_values)
            )
    ...
    def corner_variant(self, corner_variant):
        ...
        if corner_variant not in allowed_values:
            raise ValueError(
                "Invalid value for `corner_variant` ({0}), must be one of {1}"  # noqa: E501
                .format(corner_variant, allowed_values)
            )
