...
class BlockDirectoryEntry(BaseBlock):
    ...
    def __init__(self, directory_entry_id=None, directory_id=None, title=None, tags=None, link=None, image=None, variant=None, is_favorite=None, is_favorite_icon_visible=None, metadata=None, *args, **kwargs):  # noqa: E501
    ...
    def directory_entry_id(self, directory_entry_id):
        ...
        if directory_entry_id is None:
            raise ValueError("Invalid value for `directory_entry_id`, must not be `None`")  # noqa: E501
    ...
    def is_favorite_icon_visible(self, is_favorite_icon_visible):
        ...
        if is_favorite_icon_visible is None:
            raise ValueError("Invalid value for `is_favorite_icon_visible`, must not be `None`")  # noqa: E501
