...
class PostShare(object):
    ...
    def __init__(self, shared_by=None, shared_at=None, shared_to=None, site_id=None, is_pinned=None, can_pin=None, can_unshare=None):  # noqa: E501
    ...
    def shared_by(self, shared_by):
        ...
        if shared_by is None:
            raise ValueError("Invalid value for `shared_by`, must not be `None`")  # noqa: E501
    ...
    def shared_at(self, shared_at):
        ...
        if shared_at is None:
            raise ValueError("Invalid value for `shared_at`, must not be `None`")  # noqa: E501
    ...
    def shared_to(self, shared_to):
        ...
        if shared_to is None:
            raise ValueError("Invalid value for `shared_to`, must not be `None`")  # noqa: E501
    ...
    def can_pin(self, can_pin):
        ...
        """
        if can_pin is None:
            raise ValueError("Invalid value for `can_pin`, must not be `None`")  # noqa: E501
