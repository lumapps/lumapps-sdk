...
class Event(object):
    ...
    def __init__(self, id=None, author=None, organizers=None, starts_at=None, ends_at=None, location=None, external_url=None, external_url_label=None, created_at=None, updated_at=None, template_id=None, shares=None, can_edit=None, is_user_registered=None, structured_content=None):  # noqa: E501
