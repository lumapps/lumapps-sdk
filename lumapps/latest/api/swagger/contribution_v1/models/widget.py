...
class Widget(object):
    ...
    def __init__(self, widget_id=None, widget_type=None, header=None, footer=None, body=None, is_collapsed=None, style=None, css_class=None, html_id=None):  # noqa: E501
