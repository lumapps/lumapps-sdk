...
class BlockEventMetadata(BaseBlock):
    ...
    def __init__(self, event_id=None, starts_at=None, ends_at=None, location=None, external_url=None, external_url_label=None, attendees=None, attendees_count=None, is_user_registered=None, add_to_google_calendar_url=None, add_to_outlook_calendar_url=None, organizers=None, title=None, intro=None, *args, **kwargs):  # noqa: E501
    ...
    def is_user_registered(self, is_user_registered):
        ...
        if is_user_registered is None:
            raise ValueError("Invalid value for `is_user_registered`, must not be `None`")  # noqa: E501
    ...
    def add_to_google_calendar_url(self, add_to_google_calendar_url):
        ...
        if add_to_google_calendar_url is None:
            raise ValueError("Invalid value for `add_to_google_calendar_url`, must not be `None`")  # noqa: E501
    ...
    def add_to_outlook_calendar_url(self, add_to_outlook_calendar_url):
        ...
        if add_to_outlook_calendar_url is None:
            raise ValueError("Invalid value for `add_to_outlook_calendar_url`, must not be `None`")  # noqa: E501
