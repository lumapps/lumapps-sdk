...
class Article(object):
    ...
    def __init__(self, id=None, author=None, created_at=None, updated_at=None, template_id=None, owner_users=None, owner_groups=None, shares=None, can_edit=None, structured_content=None):  # noqa: E501
